...
cat vendor_bootimg/03_dtbdump_Qualcomm_Technologies,_Inc._Volcano6P_SoC.dtb.* 2>/dev/null >> vendor_bootimg/03_dtbdump_Qualcomm_Technologies,_Inc._Volcano6P_SoC.dtb
rm -f vendor_bootimg/03_dtbdump_Qualcomm_Technologies,_Inc._Volcano6P_SoC.dtb.* 2>/dev/null
